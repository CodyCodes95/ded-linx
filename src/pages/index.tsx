...
<ul className="text-sm font-medium text-center text-gray-500 rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
    ...
    <li className="w-full">
              <a href="#" onClick={() =>setTab([false, true])} className={`inline-block p-4 w-full focus:outline-none rounded-l-lg min-w-[10rem] ${tab[1] && activeClasses} ${!tab[1] && inactiveClasses}`}>Specific Links</a>
    </li>
</ul>
